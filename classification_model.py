...
# There are new lines added to this file
# Place it here to overwrite:
# /opt/python-3.7.7/lib/python3.7/site-packages/simpletransformers/classification/
...
from transformers import (
    ...
    AutoTokenizer,
    BartConfig, # line for BART
    BartTokenizerFast, # line for BART
    BertConfig,
    BertTokenizerFast,
    BertweetTokenizer,
    CamembertConfig,
...
from simpletransformers.classification.transformer_models.bart_model import BartForSequenceClassification # line for BART
    ...
    def __init__(
        ...
        **kwargs,
        ...
        MODEL_CLASSES = {
            ...
            "bart": (BartConfig, BartForSequenceClassification, BartTokenizerFast), # line for BART
